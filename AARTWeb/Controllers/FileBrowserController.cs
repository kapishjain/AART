...
namespace AARTWeb.Controllers
{
    ...
    {
        private const string contentFolderRoot = "~/Themes/Upload-File/FileBrowser";
        private const string prettyName = "Files/";
        private static readonly string[] foldersToCopy = new[] { "~/Themes/Upload-File/FileBrowser/Read" };

        //private const string contentFolderRoot = "~/Content/";
        //private const string prettyName = "Images/";
        //private static readonly string[] foldersToCopy = new[] { "~/Content/editor/" };
        private const string DefaultFilter = "*.txt,*.doc,*.docx,*.xls,*.xlsx,*.ppt,*.pptx,*.zip,*.rar";
